...
#Add your code here!
def to_dictionaries(listOfNations):
    dictToReturn = {}
    for nation in listOfNations:
        dictToReturn[nation.short_name] = {"long_name": nation.long_name, "iso_code": nation.iso_code, "iso_short": nation.iso_short, "iso_long": nation.iso_long, "capital": nation.capital}
